...
from gas import parameter
from gas.task_register import Register
...
class Task(object):
    ...
    * :py:meth:`output` - the output :py:class:`Target` that this Task creates.
    ...
    def _cached_requires(self):
        if not hasattr(self, '__cached_requires'):
            setattr(self, '__cached_requires', self.requires())
        return getattr(self, '__cached_requires')
    ...
    def _requires(self):
        ...
        the superclass.
        """
        return flatten(self._cached_requires())  # base impl
    ...
    def input(self):
        ...
        """
        return getpaths(self._cached_requires())
